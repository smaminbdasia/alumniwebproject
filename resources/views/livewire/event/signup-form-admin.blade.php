                ...
                <div class="max-w-lg mx-auto  rounded">
                    <div>
                        ...
                        <select wire:model="attendance"
                            ...
                            {{-- <select wire:model="attendance" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"> --}}
                            <option class="bangla-noto-500" value="present">স্বশরীরে উপস্থিত থাকবো, ইনশাআল্লাহ</option>
                        ...
                        <!-- Loading State -->
                        <div wire:loading class="text-gray-500 mt-2 bangla-noto-500">লোড হচ্ছে... অনুগ্রহ করে অপেক্ষা করুন</div>
                    </div>
                </div>
            </div>
